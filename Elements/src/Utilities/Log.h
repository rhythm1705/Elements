...
// Core log macros
#define ELMT_CORE_TRACE(...)    ::Elements::Log::getCoreLogger()->trace(__VA_ARGS__)
...
#define ELMT_CORE_ERROR(...)    ::Elements::Log::getCoreLogger()->error(__VA_ARGS__)
#define ELMT_CORE_CRITICAL(...) ::Elements::Log::getCoreLogger()->critical(__VA_ARGS__)
...
#define ELMT_CRITICAL(...) ::Elements::Log::getClientLogger()->critical(__VA_ARGS__)