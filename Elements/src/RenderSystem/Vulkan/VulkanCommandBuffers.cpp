...
void VulkanCommandBuffer::end() { handle.end(); }
...
void VulkanCommandBuffer::beginRenderPass(VulkanRenderPass renderPass,
    ...
    vk::RenderPassBeginInfo renderPassInfo(
      renderPass.getHandle(), framebuffer.getHandle(), renderArea, 1, clearValues.data());
...
void VulkanCommandBuffer::bindPipeline(VulkanGraphicsPipeline pipeline) {
    handle.bindPipeline(vk::PipelineBindPoint::eGraphics, pipeline.getPipeline());
}
...
void VulkanCommandBuffer::endRenderPass() { handle.endRenderPass(); }
